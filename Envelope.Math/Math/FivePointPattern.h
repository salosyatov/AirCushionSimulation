...
namespace EnvelopeMath {
	...
	*
	* @brief	аблон, состоящий из 5 точек - текущая, слева, справа, снизу, сверху.
	* 			 *
	* 			***
	* 			 *
	*
	...
	*/
	...
	class DllExport FivePointPattern : public PointPattern
	{
	...
	public:
		FivePointPattern(void);
		FivePointPattern(const TPoint & cur, const TPoint & l, const TPoint & r ,const TPoint & b, const TPoint & t);
		~FivePointPattern(void);
