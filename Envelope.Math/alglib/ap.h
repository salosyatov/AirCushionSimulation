...
void __declspec( dllexport ) vadd(double *vdst,  ae_int_t stride_dst, const double *vsrc,  ae_int_t stride_src, ae_int_t n);
void __declspec( dllexport ) vadd(double *vdst, const double *vsrc, ae_int_t N);

void __declspec( dllexport )  vadd(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n);
void __declspec( dllexport )  vadd(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N);

void __declspec( dllexport )  vadd(double *vdst,  ae_int_t stride_dst, const double *vsrc,  ae_int_t stride_src, ae_int_t n, double alpha);
void __declspec( dllexport )  vadd(double *vdst, const double *vsrc, ae_int_t N, double alpha);

void __declspec( dllexport )  vadd(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, double alpha);
void __declspec( dllexport )  vadd(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, double alpha);

void __declspec( dllexport )  vadd(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, alglib::complex alpha);
void __declspec( dllexport )  vadd(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, alglib::complex alpha);

void __declspec( dllexport ) vsub(double *vdst,  ae_int_t stride_dst, const double *vsrc,  ae_int_t stride_src, ae_int_t n);
void __declspec( dllexport ) vsub(double *vdst, const double *vsrc, ae_int_t N);

void __declspec( dllexport ) vsub(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n);
void __declspec( dllexport ) vsub(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N);

void __declspec( dllexport ) vsub(double *vdst,  ae_int_t stride_dst, const double *vsrc,  ae_int_t stride_src, ae_int_t n, double alpha);
void __declspec( dllexport ) vsub(double *vdst, const double *vsrc, ae_int_t N, double alpha);

void __declspec( dllexport ) vsub(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, double alpha);
void __declspec( dllexport ) vsub(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, double alpha);

void __declspec( dllexport ) vsub(alglib::complex *vdst, ae_int_t stride_dst, const alglib::complex *vsrc, ae_int_t stride_src, const char *conj_src, ae_int_t n, alglib::complex alpha);
void __declspec( dllexport ) vsub(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N, alglib::complex alpha);
...
********************************************************************/
class  __declspec( dllexport )  ae_vector_wrapper
{
public:
    ae_vector_wrapper();
...
class __declspec( dllexport ) real_1d_array : public ae_vector_wrapper
{
public:
    real_1d_array();
...
class __declspec( dllexport ) ae_matrix_wrapper
{
public:
    ae_matrix_wrapper();
...
class __declspec( dllexport ) real_2d_array : public ae_matrix_wrapper
{
public:
    real_2d_array();
